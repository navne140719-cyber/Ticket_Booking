...
public class BookingService {
    ...
    public void loadBookingsIntoStack() {
        ...
        List<Booking> bookings =
                bookingRepository.findAllByOrderByIdAsc();
    ...
    public List<BookingResponse> getMyBookings(
        ...
        for (Booking booking : bookings) {
             ...
             * This is only a READ.
             *
             * Therefore use normal findById().
             *
             * Do NOT use pessimistic locking here.
             */
    ...
    public Booking bookTicket(
        ...
        // =====================================================
        // GET MOVIE WITH DATABASE LOCK
        // =====================================================

        /*
         * IMPORTANT:
         *
         * Booking modifies availableSeats.
         *
         * Therefore use findByIdForUpdate().
         */

        Movie movie =
                movieRepository
                        .findByIdForUpdate(movieId)
                        .orElse(null);
...
// =====================================================
    ...
    public void cancelBooking(
        ...
        /*
         * Cancellation modifies availableSeats.
         *
         * Therefore use the locked query.
         */
